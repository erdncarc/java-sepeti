...
public class SignUpRestaurant3Activity extends BaseActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.signup_restaurant_3);
    ...
    private void addAddress(){
        ...
        location.setLatitude(BigDecimal.valueOf(selectedLatLng.latitude));
        location.setLongitude(BigDecimal.valueOf(selectedLatLng.longitude));
        ...
        RestaurantRepository.getInstance().addAddress(req, new BaseCallback<RestaurantDTO>() {
            @Override
    ...
    private void nextStep(){
        Intent goToHome = new Intent(SignUpRestaurant3Activity.this, SignUpRestaurant4Activity.class);
